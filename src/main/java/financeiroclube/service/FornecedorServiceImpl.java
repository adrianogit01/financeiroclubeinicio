...
public class FornecedorServiceImpl implements FornecedorService {
	...
	public Page<Fornecedor> listarPagina(Pageable pagina) {
		...
		return fornecedorRepository.findAllByClubeOrderByNome(clube, pagina);
	}
	...
	public void validar(Fornecedor entidade, BindingResult validacao) {
				...
				if (entidade.getCnpj() != null && fornecedorRepository
						.existsByCnpjAndClubeAndIdFornecedorNot(entidade.getCnpj(),
								usuarioService.lerLogado().getClube(), entidade.getIdFornecedor())) {
