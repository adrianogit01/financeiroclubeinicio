...
public class InicioController {
	...
	public String posLogin(Authentication authentication) {
		...
		if (userDetails.getAuthorities().contains(new SimpleGrantedAuthority("FUNCIONARIO"))) {
			retorno = "redirect:/funcionario";
		} else if (userDetails.getAuthorities().contains(new SimpleGrantedAuthority("SOCIO"))) {
